var capacitorCapgoFilePicker = (function (exports, core) {
    'use strict';

    const CapgoFilePicker = core.registerPlugin('CapgoFilePicker', {
        web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.CapgoFilePickerWeb()),
    });

    class CapgoFilePickerWeb extends core.WebPlugin {
        async pickFiles(options) {
            const files = await this.openFilePicker({
                types: options === null || options === void 0 ? void 0 : options.types,
                multiple: (options === null || options === void 0 ? void 0 : options.limit) !== 1,
            });
            const pickedFiles = [];
        ...
        async pickImages(options) {
            return this.pickFiles({
                ...
                readData: options === null || options === void 0 ? void 0 : options.readData,
            });
        }
        ...
        openFilePicker(options) {
            return new Promise((resolve) => {
                ...
                input.type = 'file';
                input.multiple = (_a = options.multiple) !== null && _a !== void 0 ? _a : true;
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        CapgoFilePickerWeb: CapgoFilePickerWeb
    });

    exports.CapgoFilePicker = CapgoFilePicker;
